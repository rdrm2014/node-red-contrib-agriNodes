...
!function () {
    ...
    var g = "https://api.windyty.com/v2.0/", h = document.getElementById("windyty");
    h || c("Missing DIV with windyty id"), h.innerHTML = '<div id="map_container" style="width:100%; height:100%;"></div><div id="contrib">OSM & contributors</div><div id="legend"></div><canvas id="jpg_decoder" style="display: none;"></canvas><div id="globe_container"></div><a class="logo" href="https://www.windyty.com" target="wndt"><img class="w" src="https://www.windyty.com/img/logo.svg"><img class="text" src="https://www.windyty.com/img/logo_windyty_11.svg"></a>', b(g + "api.css"), a("https://www.windyty.com/gfs/minifest.js", function () {
